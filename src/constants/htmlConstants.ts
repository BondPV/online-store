...
export const ClassListName = {
  ...
  cartSectionsWrap: 'cart-sections-wrap',
  cartProductWrap: 'cart-product-wrap',
  ...
  paginationPageNum: 'page-value',
  priceContainerWrap: 'price-container-wrap',
  cartHeaderList: 'cart-list',
  cartHeaderItem: 'cart-item',
  cartTotalPriceTitle: 'price-title',
  cartTotalQty: 'total-quantity',
  cartTotalPriceContainer: 'total-price-container',
  cartTotalPrice: 'total-price',
  cartDiscountPrice: 'new-price',
  cartAppliedCodesWrap: 'promo-codes-wrap',
  cartTotalPromoSubtitle: 'price-subtitle',
  cartTotalPromoList: 'promo-list',
  cartTotalPromoItem: 'promo-item',
  cartTotalPromoInput: 'promo-search',
  cartTotalPromoButton: 'promo-button',
